...
const Shell = {
  ...
  data(){ return { store, openGroup: 'crm', collapsed: false, groups: [
    { key:'crm', label:'CRM', icon:'analitica', items:[{to:'/admin',icon:'analitica',label:'Tablero'},{to:'/admin/leads',icon:'users',label:'Leads'},{to:'/admin/funnel',icon:'analitica',label:'Funnel y pauta'},{to:'/admin/pipeline',icon:'growth',label:'Pipeline'},{to:'/admin/propuestas',icon:'doc',label:'Propuestas'},{to:'/admin/buzon',icon:'mail',label:'Buzón'},{to:'/admin/growthboard',icon:'target',label:'GrowthBoard Clientes'},{to:'/admin/campanas',icon:'growth',label:'Campañas'},{to:'/admin/resenas',icon:'sparkle',label:'Reseñas'},{to:'/admin/testimonios',icon:'people',label:'Testimonios'},{to:'/admin/segmentos',icon:'target',label:'Segmentos'},{to:'/admin/reservas',icon:'calendar',label:'Reservas'},{to:'/admin/disponibilidad',icon:'clock',label:'Disponibilidad'}] },
